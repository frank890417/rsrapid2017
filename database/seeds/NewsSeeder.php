...
class NewsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        for($i=0;$i<20;$i++){
          $now_size=1;
          News::create([
            'title' => ["鴻海攜手中山大學成立睿軒　玩具義診10秒內檢測塑化劑","全方位企業檢測方案","解讀先天遺傳癌症風險","為安全出發讓生活更美好"][rand(0,3)],
            ...
            'description' => ["兒童節即將到來，鴻海旗下永齡健康基金會今年首波公益行動將全台走透透，為偏鄉弱勢的400所幼兒園進行「玩具義診」","癌症風險，傳統健檢Out、精準醫療In，罹癌時鐘越跑越快。"][1],
